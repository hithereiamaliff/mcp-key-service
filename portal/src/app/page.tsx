        ...
        <div className="rounded-xl border border-[var(--border)] p-6 bg-[var(--card)] space-y-4 shadow-[0_20px_80px_rgba(15,23,42,0.2)]">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <button
              ...
              className="w-full py-2.5 px-4 rounded-lg border border-[var(--border)] font-medium hover:bg-[var(--bg-secondary)] disabled:opacity-50 flex items-center justify-center gap-2"
            >
